# -*- coding: utf-8 -*-
# Generated by Django 1.9.7 on 2016-08-11 10:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dps.OrderCategory')),
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ship.Customer')),
                ('material_ctrl', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='dps.MaterialCtrlOption')),
        ...
        migrations.AddField(
            ...
            name='zmms',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='dps.ZmmsOption'),
        ),
    ]
